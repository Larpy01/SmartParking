        ...
        <nav class="flex-1 px-2 py-4 space-y-6 overflow-y-auto">
            ...
            @elseif (auth()->user()->hasOperatorAccess())
                <div class="space-y-1 pt-2">
                    ...
                    <a href="{{ route('vehicles.index') }}" class="flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-orange-600 hover:bg-orange-50 transition sidebar-link">
